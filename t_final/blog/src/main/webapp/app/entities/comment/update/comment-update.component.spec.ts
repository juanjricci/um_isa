...
describe('Comment Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: 1951 };
      comment.user = user;

      const userCollection: IUser[] = [{ id: 17679 }];
    ...
    it('Should call Post query and add missing value', () => {
      const comment: IComment = { id: 456 };
      const post: IPost = { id: 4351 };
      comment.post = post;

      const postCollection: IPost[] = [{ id: 4851 }];
    ...
    it('Should update editForm', () => {
      const comment: IComment = { id: 456 };
      const user: IUser = { id: 422 };
      comment.user = user;
      const post: IPost = { id: 7617 };
      comment.post = post;
