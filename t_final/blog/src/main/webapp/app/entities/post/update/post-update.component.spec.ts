...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 8226 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 2200 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tag: ITag = { id: 32697 };
      post.tag = tag;

      const tagCollection: ITag[] = [{ id: 17800 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 29667 };
      post.blog = blog;
      const tag: ITag = { id: 9711 };
      post.tag = tag;
