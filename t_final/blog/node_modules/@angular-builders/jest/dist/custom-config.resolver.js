...
class CustomConfigResolver {
    ...
    resolveGlobal(workspaceRoot) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return workspaceJestConfigPath
                ? yield resolveJestConfig(workspaceJestConfigPath, tsConfig, this.logger)
                : {};
        });
    }
    resolveForProject(projectRoot, configPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield resolveJestConfig(jestConfigPath, tsConfig, this.logger);
        });
    }
}
exports.CustomConfigResolver = CustomConfigResolver;
function resolveJestConfig(jestConfigPath, tsConfig, logger) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, utils_1.tsNodeRegister)(jestConfigPath, tsConfig, logger);
        return yield (0, utils_1.loadModule)(jestConfigPath);
    });
}
