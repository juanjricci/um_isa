...
which is free for the first 30 days`);
            ...
            azureAzureAppServiceConfig: runAsync(function () {
                ...
                exec(`az webapp config appsettings set --resource-group ${this.azureAppServiceResourceGroupName} --name ${this.azureAppServiceName} --settings SPRING_PROFILES_ACTIVE=prod,azure`, err => {
                    if (err) {
                        this.abort = true;
