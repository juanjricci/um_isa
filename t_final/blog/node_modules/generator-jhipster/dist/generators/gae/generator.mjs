    ...
    get initializing() {
        return {
            ...
            checkAppEngineJavaComponent: runAsync(function () {
                ...
                shelljs.exec('gcloud components list --quiet --filter="Status=Installed OR Status=\\"Update Available\\"" --format="value(id)"', { silent: true }, (err, stdout) => {
    ...
    get configuring() {
        return {
            ...
            createCloudSqlLogin: runAsync(function () {
                ...
                const name = this.gcpCloudSqlInstanceName.split(':')[2];
                shelljs.exec(`gcloud sql users list -i jhipster --format="value(name)" --project="${this.gcpProjectId}"`, { silent: true }, (_code, stdout) => {
