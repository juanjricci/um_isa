import { GENERATOR_BOOTSTRAP, GENERATOR_CLIENT, GENERATOR_COMMON, GENERATOR_CYPRESS, GENERATOR_GIT, GENERATOR_LANGUAGES, GENERATOR_SERVER, } from '../generator-list.mjs';
const command = {
    options: {
        defaults: {
