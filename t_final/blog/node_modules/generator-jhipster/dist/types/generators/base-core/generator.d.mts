...
import type { JHipsterGeneratorOptions, JHipsterGeneratorFeatures, EditFileCallback, EditFileOptions, CascatedEditFileCallback, JHipsterOptions, ValidationResult, WriteFileOptions, JHipsterArguments, JHipsterConfigs, JHipsterCommandDefinition } from '../base/api.mjs';
...
export default class CoreGenerator extends YeomanGenerator<JHipsterGeneratorOptions, JHipsterGeneratorFeatures> {
    ...
    prepareQuestions(configs?: JHipsterConfigs): {
        ...
        transformer?: any;
        name: string;
        choices: import("../base/api.mjs").JHispterChoices | undefined;
    }[];
    /**
