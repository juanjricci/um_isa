...
export declare function addRoute({ needle, route, pageTitle, title, modulePath, moduleName, component, }: {
    ...
    moduleName?: string;
    component?: boolean;
}): import("../../base/api.mjs").EditFileCallback<import("../../index.js").GeneratorBaseCore>;
export declare function addEntitiesRoute({ application, entities }: {
...
export declare const addItemToAdminMenu: (menu: MenuItem) => import("../../base/api.mjs").EditFileCallback<import("../../index.js").GeneratorBaseCore>;
export declare const addIconImport: ({ icon }: {
    icon: string;
}) => import("../../base/api.mjs").EditFileCallback<import("../../index.js").GeneratorBaseCore>;
export declare function addToEntitiesMenu({ application, entities }: {
