...
export function buildCommands({ program, commands, envBuilder, env, loadCommand, defaultCommand, printLogo, printBlueprintLogo, createEnvBuilder, }: {
    program: any;
    commands?: {} | undefined;
    envBuilder: any;
    env: any;
...
export function buildJHipster({ executableName, executableVersion, program, blueprints, lookups, createEnvBuilder, envBuilder, commands, printLogo, printBlueprintLogo, devBlueprintPath, env, loadCommand, defaultCommand, }?: {
    executableName: any;
    executableVersion: any;
